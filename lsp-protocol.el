...
(lsp-interface (terraform-ls:ModuleCalls (:v :module-calls) nil))
(lsp-interface (terraform-ls:Module (:name :docs-link :version :source-type :dependent-modules) nil))
(lsp-interface (terraform-ls:Providers (:v :provider-requirements :installed-providers) nil))
(lsp-interface (terraform-ls:module.terraform (:v :required-version :discovered-version)))
